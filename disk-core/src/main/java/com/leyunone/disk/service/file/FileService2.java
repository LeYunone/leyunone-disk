...
import com.leyunone.disk.model.co.FileInfoCO;
import com.leyunone.disk.model.co.FileMd5CO;
...
import com.leyunone.disk.command.SliceUploadExe;
...
//        ptDownload(fileDTO);
    ...
    private void threadDownload(DownloadFileDTO fileDTO) {
        ...
        //开启多线程下载
        Long threadSize = fileSize / FileService2.downloadThreadCount;
        int threadCount = 0;
        while (threadCount <= FileService2.downloadThreadCount) {
